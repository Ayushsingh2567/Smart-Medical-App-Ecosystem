      ...
      <div className="bg-slate-900 text-slate-200 px-4 py-1.5 text-xs flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300 hidden sm:inline">
            ABHA Digital Health Stack Enabled
          </span>
          ...
          >
            ...
            View Smart Referral Workflow Diagram
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative group">
            <button className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-slate-100 px-2.5 py-1 rounded-md text-xs font-medium border border-slate-700 transition-colors">
              {activeRoleObj?.icon}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 hidden sm:block">
                Connected Health, Live Bed Triage & AI Medical Services
              </p>
            </div>
          </div>

          {/* Role Banner Badge */}
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full border text-xs font-medium bg-slate-50 border-slate-200">
